<?php /* Smarty version 2.6.18, created on 2014-04-03 03:12:48
         compiled from C:%5CAppServ%5Cwww%5Cismosite%5Cadmin/content/templates/productos.html */ ?>
<style type="text/css">
...
<div class="left itemlist" style="width: 1625px;">
            <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
				...
				<?php $_from = $this->_tpl_vars['obj']->productos; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['producto']):
?>	
					<tr>
						<td><?php echo $this->_tpl_vars['producto']->id; ?>
</td>
						<td><?php echo $this->_tpl_vars['producto']->idCategoria; ?>
</td>
						<td><?php echo $this->_tpl_vars['producto']->titulo; ?>
</td>
						<td><?php echo $this->_tpl_vars['producto']->descripcion; ?>
</td>
						<td><?php echo $this->_tpl_vars['producto']->texto; ?>
</td>
						<td><?php echo $this->_tpl_vars['producto']->img; ?>
</td>
 						<td><?php echo $this->_tpl_vars['producto']->visible; ?>
</td>
						<td align="center" class="btonActionItem" width="170">
							<a href="javascript:;" rel="editar|<?php echo $this->_tpl_vars['producto']->id; ?>
">
							<img src="images/iconEditUser.png" border="0" align="middle" class="left">
							<span style="float:left; margin:7px 0 0 5px;">Editar</span>
							</a>
							<a href="javascript:;" rel="eliminar|<?php echo $this->_tpl_vars['producto']->id; ?>
">
...
jQuery("[rel^='editar']").click(function(){
	...
	var HTML='<div id="editar" width="600" >';
        ...
        HTML+=' <td align="left" width="135"><select name="idCategoria"><option value="0">Ninguno</option><?php $_from = $this->_tpl_vars['obj']->categorias; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['id'] => $this->_tpl_vars['categoria']):
?><option value="<?php echo $this->_tpl_vars['categoria']->id; ?>

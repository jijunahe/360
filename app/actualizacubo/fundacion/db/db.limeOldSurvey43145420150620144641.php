<?php
/**
 * Table Definition for lime_old_survey_431454_20150620144641
 */

class DataObjects_LimeOldSurvey43145420150620144641 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_old_survey_431454_20150620144641';    // table name
    ...
    public $_431454X14X245;                   // string(5)  
    ...
    public $_431454X18X596;                   // string(5)  
    ...
    public $_431454X18X602;                   // string(5)  
    ...
    public $_431454X22X534;                   // string(5)  
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeOldSurvey43145420150620144641',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '431454X14X245' =>  DB_DATAOBJECT_STR,
             ...
             '431454X22X534' =>  DB_DATAOBJECT_STR,

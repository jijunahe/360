<?php
/**
 * Table Definition for lime_old_survey_317614_20151110160610
 */

class DataObjects_LimeOldSurvey31761420151110160610 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_old_survey_317614_20151110160610';    // table name
    ...
    public $_317614X32X741;                   // blob(65535)  blob
    ...
    public $_317614X32X742;                   // string(1)  
    ...
    public $_317614X32X744;                   // blob(65535)  blob

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeOldSurvey31761420151110160610',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '317614X32X744' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_BLOB,
         );
    }

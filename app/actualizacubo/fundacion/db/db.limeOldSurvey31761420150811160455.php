<?php
/**
 * Table Definition for lime_old_survey_317614_20150811160455
 */

class DataObjects_LimeOldSurvey31761420150811160455 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_old_survey_317614_20150811160455';    // table name
    ...
    public $_317614X32X717;                   // string(1)  
    public $_317614X32X718;                   // string(1)  
    public $_317614X32X719;                   // string(1)  
    public $_317614X32X720;                   // string(1)  
    public $_317614X32X721;                   // string(5)  
    public $_317614X32X722;                   // real(32)  
    public $_317614X32X723;                   // string(1)  
    public $_317614X32X724;                   // real(32)  

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeOldSurvey31761420150811160455',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '317614X32X722' =>  DB_DATAOBJECT_INT,
             '317614X32X723' =>  DB_DATAOBJECT_STR,
             '317614X32X724' =>  DB_DATAOBJECT_INT,
         );
    }

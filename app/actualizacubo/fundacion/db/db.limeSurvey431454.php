<?php
/**
 * Table Definition for lime_survey_431454
 */

class DataObjects_LimeSurvey431454 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_survey_431454';              // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeSurvey431454',$k,$v); }

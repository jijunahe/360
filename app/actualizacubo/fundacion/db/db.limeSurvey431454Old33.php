<?php
/**
 * Table Definition for lime_survey_431454_old33
 */

class DataObjects_LimeSurvey431454Old33 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_survey_431454_old33';        // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeSurvey431454Old33',$k,$v); }

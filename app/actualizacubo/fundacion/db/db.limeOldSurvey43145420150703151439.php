<?php
/**
 * Table Definition for lime_old_survey_431454_20150703151439
 */

class DataObjects_LimeOldSurvey43145420150703151439 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_old_survey_431454_20150703151439';    // table name
    ...
    public $_431454X14X655;                   // string(5)  
    ...
    public $_431454X25X656;                   // datetime(19)  binary
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeOldSurvey43145420150703151439',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '431454X25X656' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_DATE + DB_DATAOBJECT_TIME,

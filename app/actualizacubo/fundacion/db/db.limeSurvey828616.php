<?php
/**
 * Table Definition for lime_survey_828616
 */

class DataObjects_LimeSurvey828616 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_survey_828616';              // table name
    ...
    public $_828616X27X730;                   // blob(65535)  blob
    public $_828616X27X731;                   // blob(65535)  blob
    public $_828616X27X732;                   // blob(65535)  blob
    public $_828616X27X658;                   // real(32)  
    public $_828616X27X666;                   // real(32)  
    public $_828616X27X659;                   // real(32)  
    public $_828616X27X668;                   // blob(65535)  blob
    public $_828616X27X743;                   // blob(65535)  blob
    ...
    public $_828616X31X745;                   // string(1)  
    public $_828616X27X1462;                   // string(1)  

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeSurvey828616',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '828616X27X730' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_BLOB,
             '828616X27X731' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_BLOB,
             '828616X27X732' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_BLOB,
             '828616X27X658' =>  DB_DATAOBJECT_INT,
             '828616X27X666' =>  DB_DATAOBJECT_INT,
             '828616X27X659' =>  DB_DATAOBJECT_INT,
             '828616X27X668' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_BLOB,
             '828616X27X743' =>  DB_DATAOBJECT_STR + DB_DATAOBJECT_BLOB,
             ...
             '828616X31X745' =>  DB_DATAOBJECT_STR,
             '828616X27X1462' =>  DB_DATAOBJECT_STR,
         );
    }

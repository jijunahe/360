<?php
/**
 * Table Definition for view_transformadadoble
 */

class DataObjects_ViewTransformadadoble extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'view_transformadadoble';          // table name
    public $_id;                              // int(12)  not_null
    public $_idEncuesta;                      // int(12)  
    public $_anw_id;                          // int(12)  
    public $_anw_submitdate;                  // datetime(19)  binary
    public $_anw_hora;                        // string(2)  
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_ViewTransformadadoble',$k,$v); }

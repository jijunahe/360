<?php
/**
 * Table Definition for lime_survey_317614_old
 */

class DataObjects_LimeSurvey317614Old extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_survey_317614_old';          // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeSurvey317614Old',$k,$v); }

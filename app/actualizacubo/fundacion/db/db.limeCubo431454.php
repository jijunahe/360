<?php
/**
 * Table Definition for lime_cubo_431454
 */

class DataObjects_LimeCubo431454 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_cubo_431454';                // table name
    ...
    public $_idAnswer;                        // int(12)  unique_key

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeCubo431454',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '431454X25X656' =>  DB_DATAOBJECT_STR,
             'valorEscala431454X25X656' =>  DB_DATAOBJECT_INT,

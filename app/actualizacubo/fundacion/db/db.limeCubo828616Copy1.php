<?php
/**
 * Table Definition for lime_cubo_828616_copy1
 */

class DataObjects_LimeCubo828616Copy1 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_cubo_828616_copy1';          // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeCubo828616Copy1',$k,$v); }

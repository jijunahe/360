<?php
/**
 * Table Definition for lime_survey_317614_copy
 */

class DataObjects_LimeSurvey317614Copy extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_survey_317614_copy';         // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeSurvey317614Copy',$k,$v); }

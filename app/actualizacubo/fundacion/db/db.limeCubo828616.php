<?php
/**
 * Table Definition for lime_cubo_828616
 */

class DataObjects_LimeCubo828616 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_cubo_828616';                // table name
    public $_id;                              // int(12)  not_null primary_key auto_increment
    public $_token;                           // string(50)  
    public $_fecharegistro;                   // string(10)  
    ...
    public $_referencia;                        // int(12)  
    public $_idtoken;                        // int(12)  
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeCubo828616',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             'fecharegistro' =>  DB_DATAOBJECT_STR,
             ...
             'referencia' =>  DB_DATAOBJECT_INT,
             'idtoken' =>  DB_DATAOBJECT_INT,

<?php
/**
 * Table Definition for lime_survey_828616_ol
 */

class DataObjects_LimeSurvey828616Ol extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_survey_828616_ol';           // table name
    ...
    public $_828616X27X665;                   // string(1)  

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeSurvey828616Ol',$k,$v); }

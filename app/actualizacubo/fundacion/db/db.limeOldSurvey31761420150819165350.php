<?php
/**
 * Table Definition for lime_old_survey_317614_20150819165350
 */

class DataObjects_LimeOldSurvey31761420150819165350 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_old_survey_317614_20150819165350';    // table name
    ...
    public $_317614X32X729;                   // real(32)  

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeOldSurvey31761420150819165350',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '317614X32X729' =>  DB_DATAOBJECT_INT,
         );
    }

<?php
/**
 * Table Definition for lime_normalizada_828616
 */

class DataObjects_LimeNormalizada828616 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_normalizada_828616';         // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeNormalizada828616',$k,$v); }

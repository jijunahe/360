<?php
/**
 * Table Definition for lime_old_survey_317614_20150819125138
 */

class DataObjects_LimeOldSurvey31761420150819125138 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'lime_old_survey_317614_20150819125138';    // table name
    ...
    public $_317614X32X726;                   // real(32)  

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_LimeOldSurvey31761420150819125138',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             '317614X32X726' =>  DB_DATAOBJECT_INT,
         );
    }

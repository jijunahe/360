<?php 
	...
	class Action{
		...
		public function init(){
			//printVar($this->validaTable);exit;
			if($this->validaTable>0){
				...
				if($totalesEncuesta>0){
						...
						if(($resultadoEncuesta[0]["submitdate"]!="" and  !isset($test[0]["idAnswer"]))){
							...
							if((int)$csid==$this->id){
								...
								if($test!=NULL){
									...
									if($valor!=""){
										if($campo!="913233X59X1543"){
											$valor=trim(removeAccents(utf8_encode($valor))," "); 
										}
										if($campo=="913233X59X1554"){
											$valor=number_format($valor,0);
										}
										if($campo=="913233X59X1553"){
											$valor=(int)$valor;
										}
					...
					$indice=number_format($info["913233X59X1554"]/(($info["913233X59X1553"]/100)*($info["913233X59X1553"]/100)),2);
					...
					$fechanacimiento=$info["913233X59X1543"];
					$edad=calcularedad($info["913233X59X1543"]);
					$info["edad"]=$edad;
					...
					//DIABETES
					if($info["913233X59X1582"]=="Y" ){
						$diabetes=1;
					}							
					//TABAQUISMO 
					if($info["913233X59X1579"]=="Y" ){
						$tabaquismo=1;
					}				
					
					$lnedad=$this->params[$g]["RF"]["Log_of_age"]*number_format(log ((int)$edad),30);
					$lncoltotal=$this->params[$g]["RF"]["Log_of_CT"]*number_format(log ((int)$info["913233X59X1573"]),30);
					$lnhdl=$this->params[$g]["RF"]["Log_of_hdl"]*number_format(log ((int)$info["913233X59X1574"]),30);
					//------------------------------------------------------------------- Tensi&oacute;n sist&oacute;lica
					$lntas=$this->params[$g]["RF"]["Log_of_SBP"]*number_format(log ((int)$info["913233X59X1577"]),30);
					//-------------------------------------------------------------------
					...
					$modificadoProcam=number_format((/*$pot-*/($pot*0.75))*100,2);
					...
					'colesterol_en_mmol_litro'=>array("M"=>0.24,"F"=>0.02,"I"=>(number_format($info["913233X59X1573"],30)/37.5)),
					//----------------------------------------------------------------------------// Presi&oacute;n sist&oacute;lica
					'Presion_sistolica_en_mmHg'=>array("M"=>0.018,"F"=>0.022,"I"=>number_format($info["913233X59X1577"],30))
					//----------------------------------------------------------------------------------
					);
					...
					"913233X59X1545"=>"Nombre y Apellidos",
					"913233X59X1548"=>"Documento de identidad",
					"913233X59X1546"=>"N&uacute;mero de celular",
					"913233X59X1547"=>"G&eacute;nero",
					
					"425936X35X1158"=>"Correo electr&oacute;nico",
					
					"913233X59X1543"=>"Fecha de nacimiento",
					"913233X59X1553"=>"Estatura en cent&iacute;metros",
					"913233X59X1554"=>"Peso en kilogramos",
					"indice"=>"Índice de masa corporal",
					"estadoCorporal"=>"Estado corporal",
					"913233X59X1570"=>"Per&iacute;metro de la cintura en cent&iacute;metros",
					"913233X59X1571"=>"Glicemia en sangre en ayunas",
					"913233X59X1572"=>"Triglic&eacute;ridos",
					"913233X59X1573"=>"COLESTEROL TOTAL",
					"913233X59X1574"=>"COLESTEROL HDL",
					"913233X59X1575"=>"¿Practicas alguna actividad f&iacute;sica?",
					"edad"=>"Edad",
					"913233X59X1579"=>"¿Eres fumador?",
					"913233X59X1580"=>"¿Sufre de hipertensi&oacute;n Arterial?",
					"913233X59X1577"=>"Tensi&oacute;n Arterial Sist&oacute;lica",
					"913233X59X1578"=>"Tensi&oacute;n Arterial Diast&oacute;lica",
					...
					"913233X59X1582"=>"¿Sufres de diabetes?",
					...
					foreach($objCols as $key=>$value){
						...
						if( !in_array($key,$valida)){ 
							if($value!="No responde"){
								...
								if($key=="913233X59X1570"){
									$value=$value."<br>".$this->analisis("913233X59X1570",$value,$info["913233X59X1547"]);
								}
								
								
								if($key=="913233X59X1571"){
									$value=$value."<br>".$this->analisis("913233X59X1571",$value);
								}
								
								
								if($key=="913233X59X1574"){
									$value=$value."<br>".$this->analisis("913233X59X1574",$value);
								}
								
								if($key=="913233X59X1575"){
									$value=$value."<br>".$this->analisis("913233X59X1575",$value);
								}
								
								if($key=="913233X59X1579"){
									$value=$value."<br>".$this->analisis("913233X59X1579",$value);
								}
								
								if($key=="913233X59X1580"){
									$value=$value."<br>".$this->analisis("913233X59X1580",$value);
								}
								
								if($key=="913233X59X1578"){
									$value=$value."<br>".$this->analisis("913233X59X1578",$value);
								}
		...
		public function analisis($key,$valor,$genero=""){
			...
			switch($key){
				...
				case "913233X59X1570"://PERIMETRO CINTURA
				...
				case "913233X59X1574":// COLESTEROL HDL
				...
				case "913233X59X1575"://Practicas alguna actividad f&iacute;sica?
					if($valor=="No"){
				...
				case "913233X59X1579"://Eres fumador?
					if($valor=="No"){
						$resultado="Felicidades<br>";
				...
				case "913233X59X1578":// PRESION DIASTOLICA

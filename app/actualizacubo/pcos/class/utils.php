...
function senEmail( $info,$html){
	 
	if($info["214322X50X1422"]!="NR"){
		...
		$mail->Username   = "support@talentracking.com";  // GMAIL username
		$mail->Password   = "t4l3ntr4ck1ng";            // GMAIL password
		$mail->AddAddress($info["214322X50X1422"],"Trackeratwork");
		$mail->SetFrom('support@talentracking.com', 'Trackeratwork');
		$mail->AddReplyTo('fgutierrez@talentracking.com', 'Trackeratwork');
 		$mail->Subject = utf8_decode("Ser felíz paga!");

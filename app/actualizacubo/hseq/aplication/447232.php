			...
			if($this->validaTable>0){
				...
				if($totalesEncuesta>0){
					...
					if(!isset($test2[0]["idAnswer"])){
						...
						//$info["submitdate"]=$info["submitdate"];
								...
								if(isset($test2[2])){
									...
									if(isset($valorpregunta[0]["question"])){
										...
										if($valida==true){	
											...
											$datatrans["submitdate"]=$info["submitdate"];
					...
					"751388X41X1226"=>"G&eacute;nero",
					"425936X35X1158"=>"Correo electr&oacute;nico",
					"751388X41X1228"=>"Fecha de nacimiento",
					"751388X42X1370"=>"Estatura en cent&iacute;metros",
					"751388X42X1230"=>"Peso en kilogramos",
						...
						if( !in_array($key,$valida)){ 
							if($value!="No responde"){
								...
								if($key=="425936X35X1163"){
									$value=$value."<br>".$this->analisis("425936X35X1163",$value,$info["751388X41X1226"]);
								}

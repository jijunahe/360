...
function ajustarbanner(){
 ...
 <div id="content">  
	...
	<img class="bannermodulo"  <?php if($demo==true){ ?>id="costos" style="cursor:pointer;width:100%;height:20%"<? } else{?> style="width:100%;height:20%" <? } ?> rel="moduloreportes.png"  />
	...
	<div class="divContentBlue"> 
		...
		<div class="divContentWhite">
			...
			?>
				...
				<?php echo CHtml::form(array("admin/rcv/reportes"), 'post', array('class'=>'acciones' , 'id'=>'acciones')); ?>
				...
				<?=$buscando?>					
			<iframe id="reporte" name="reporte" src="https://www.talentracking.co/node/252?embed=1&idestructura=<?=$idestructura?>&token=<?=$token?><?=$param?>"  ></iframe>  

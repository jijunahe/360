...
<div id="content" style="padding:10px">
	<div class="divContentBlue">
	 <h3>Subir un archivo</h3><div style="clear:both"></div>
		<div class="divContentWhite">
			<?php echo CHtml::form(array("admin/modulos"), 'post', array('class'=>'formulario' , 'id'=>'formCrear','style'=>'margin:0px; padding:0px;','enctype'=>'multipart/form-data')); ?>
						<br />

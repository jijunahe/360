                    ...
                    <h1>Registro</h1>
                     <span class="typed">
 						...
 						<?php echo CHtml::form(array("admin/estructuraorg/actionsorg/"), 'post', array('class'=>'eliminar', 'id'=>'formEliminar')); ?>
							...
							<input type="hidden" name="RegistrarOrganizacion[id]" value="-1" />
						</form>
						<div id="content"  >
							...
							<td id="addUpdate">
								<div class="divContentBlue"> 
								  ...
								  <?php echo CHtml::form(array("admin/authentication/actionsregistrar"), 'post', array('class'=>'formularioEstructura', 'id'=>'formForm')); ?>
								  <input type="hidden" name="option" id="option" value="create" />
								  <table cellpadding="0" cellspacing="0" border="0" width="100%">
									<tr>
									  <td>Nombre de la empresa:</td>
									  <td><input type="text" id="nombreempresa" name="RegistrarOrganizacion[nombre]" style="width:85%"  maxlength="200" />
										  </td>
									</tr>
									<tr>
									  <td>Nombre Responsable:</td>
									  <td><input type="text" id="nombreresponsable" name="RegistrarOrganizacion[representantelegal]" style="width:85%" maxlength="200" />
										  </td>
									</tr>				
									
									<tr>
									  <td>Documento:</td>
									  <td><input type="text" id="docidentidadcontacto" name="RegistrarOrganizacion[docidentidadcontacto]" style="width:85%"  maxlength="200" />
										  </td>
									</tr>				
									
									<tr>
									  <td>Tipo de empresa:</td>
									  <td><select id="tipo" name="RegistrarOrganizacion[idtipoorganizacion]" style="width:85%;"  >
									...
									<tr>
									  <td>Cargo:</td>
									  <td><input type="text" id="cargo" name="RegistrarOrganizacion[cargo]" style="width:85%"  maxlength="200" />
										  </td>
									</tr>
									 
									<tr>
									  <td>Área:</td>
									  <td><select id="area" name="RegistrarOrganizacion[idarea]" >
										  <option value="-1">Seleccione...</option>
									...
									<tr>
									  <td>Teléfono:</td>
									  <td><input type="number" id="telefono" name="RegistrarOrganizacion[telefono]" style="width:85%"  maxlength="200" />
										  </td>
									</tr>
									...
									<tr>
									  <td>e-mail:</td>
									  <td><input type="text" id="email" name="RegistrarOrganizacion[emailcontacto]" style="width:85%"  maxlength="200" />
										  </td>
									</tr>
								  ...
								  <center><div  style="width:150px;height:40px">
								  <input type="button" id="b_create" value="Guardar" rel="b_create"  style="float:left;" />
								  <input type="button" id="volver" value="Volver" rel="volver" style="float:left;margin-left:20px"  />
								  </div>
								  </center>

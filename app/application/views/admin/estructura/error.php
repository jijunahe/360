                     ...
                     <span class="typed">
						...
						<div  >
							 <div class="divContentBlue"> 
									  <div class="divContentWhite"><center><h2>El email ingresado ya existe, por favor comuníquese con support@talentracking.com para dar seguimiento al problema o haga click en volver para intentar con otro email.</h2><input type="button" id="volver" value="Volver" /></center></div>
							</div>
						</div>												
...
jQuery(function(){
	...
	jQuery("#volver").click(function(){
		document.location="<?=Yii::app()->baseUrl?>/index.php/admin/authentication/registrar";

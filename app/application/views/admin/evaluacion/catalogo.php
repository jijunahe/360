        ...
        <div id="page-wrapper">
            ...
            <div class="row" style="padding-left:13px;padding-right:13px">
				<div  class="col-lg-12" id="contenedorbr">
						...
						<div class="panel panel-default" style="overflow-y:scroll; height: 96% !important">
							<div class="panel-heading">
							
								<div class="pull-left" > <strong><?=$idioma->{"catalogocompetencias"}?></strong><br>
									<?=$idioma->descripcioncatalogo?>

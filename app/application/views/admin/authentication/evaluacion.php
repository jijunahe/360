            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=$idioma->bienvenido?></h3>
                    </div>
                    <div class="panel-body">
                       <?php echo CHtml::form(array('admin/authentication/evaluacion'), 'post', array('id'=>'loginform', 'name'=>'loginform',"autocomplete"=>"off"));?>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control"  name="hashcontrol" type="hidden" value="<?=($_GET["token"])?>">
                                </div>
                                <div class="form-group">
                                    <span rel="recuperar" style="cursor:pointer"><?=$idioma->recuperarpassword?>
                                    </span>
                                </div>
...
<center>  
  <div class="container" >
        <div class="row" id="titulo">
			...
			<strong id="subtitle"><?=$idioma->evaluacion?></strong> 
        </div>
        <div class="row">
            <div class="col-md-5 ">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                       <?php echo CHtml::form(array('admin/authentication/evaluacion'), 'post', array('id'=>'loginform', 'name'=>'loginform',"autocomplete"=>"off"));?>
                            ...
                            <fieldset>
								...
								<br>
								<div class="form-group">
                                    <span rel="recuperar" style="cursor:pointer"><?=$idioma->recuperarpassword?></span>
                                </div>
                             </fieldset>
                        </form>
                    </div>

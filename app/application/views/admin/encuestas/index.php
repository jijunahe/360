...
<script type="text/javascript">
 ...
 function Activa(){
	 ...
	 jQuery("[rel^='parametrizar']").click(function(){
		var id=jQuery(this).attr("rel").split("_")[1];
			 ...
			 <?php echo CHtml::form(array("admin/encuestas/baremos"), 'post', array('class'=>'formB', 'id'=>'formB')); ?>
			  ...
			  <table cellpadding="0" cellspacing="0" border="0" width="100%" id="tableContent">
			    <tr>
				  ...
				  <td><b>Parametrizar dominios y dimensiones</b></td>
				  <td><b>Clasificar preguntas</b></td>
				  <td><b>Baremos</b></td>
 				</tr>
				<?PHP
				foreach($encuestas as $obj){
					...
					<tr>
 					  <td>
 						<input type='button' value='".$obj->surveyls_survey_id."' rel='editar_".$obj->surveyls_survey_id."' style='width:100%' />
 					  </td>
					  ...
					  if($sufijo>0){
						...
						echo ("<input type='button' value='Parametrizar' rel='parametrizar".$sufijo."_".$obj->surveyls_survey_id."' style='width:100%' />");
					
						}
					echo (" </td>
					  <td>
					  
						 	<input type='button' value='Clasificar' rel='clasificar_".$obj->surveyls_survey_id."' style='width:100%' />

					  </td>
					  <td>
					  
						 	<input type='button' value='Baremos' rel='baremos_".$obj->surveyls_survey_id."' style='width:100%' />

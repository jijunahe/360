...
.custom-file-input {
 ...
 jQuery(function(){
	 ...
	 jQuery("#organizacion").change(function(){
		jQuery("#formu").submit(); 
		...
		<div style="clear:both"></div>
		 <h3><?=$titulo?></h3><div style="clear:both"></div>
			<div class="divContentWhite">
				<?php echo CHtml::form(array("admin/avanzado"), 'GET', array('class'=>'formu' , 'id'=>'formu')); ?>
					Seleccione una empresa <select id="organizacion" name="organizacion" >
						<option></option>
						<? foreach($empresas as $org){ ?>

		...
		<td>
			...
			<div class="divContentBlue">
				<div style="float:left">
					<div style="float:left"><h3>Listado de personas </h3></div>
					
					<div style="float:left;margin-top:10px;margin-left:40px" class="paginaselected">
						<?php echo CHtml::form(array("admin/usuarios/"), 'post', array('class'=>'filtrounidades', 'id'=>'filtrounidades','style'=>'float: left')); ?>
							<? // printVar($empl[3]); ?>
					...
					<div style="float:left;margin-top:10px;margin-left:40px" class="paginaselected">
						<?php echo CHtml::form(array("admin/usuarios/"), 'post', array('class'=>'filtroperfil', 'id'=>'filtroperfil','style'=>'float: left')); ?>
							 <input type="hidden" id="option" name="option" value="<?=$option?>" />
					...
					<div style="float:left;margin-top:10px;margin-left:40px" class="paginaselected">
					<?php echo CHtml::form(array("admin/usuarios/"), 'post', array('class'=>'buscarForm', 'id'=>'buscarForm','style'=>'float: left')); ?>
						 <input type="hidden" id="option" name="option" value="<?=$option?>" />
			 ...
			 <?php echo CHtml::form(array("admin/usuarios/"), 'post', array('class'=>'paginar', 'id'=>'paginar')); ?>

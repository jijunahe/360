                     ...
                     <span class="typed">
						...
						<div  >
							 <div class="divContentBlue"> 
									  <div class="divContentWhite"><center><h2>El usuario no esta asignado al organigrama de la organización</h2><input type="button" id="volver" value="Volver" /></center></div>
							</div>
						</div>												

...
/**
 * This is the model class for table "{{registrousuario}}".
 *
 * The followings are the available columns in table '{{registrousuario}}':
 * @property integer $id
...
class Registrousuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, token, idusuario, fecharegistro', 'safe', 'on'=>'search'),
		);
	}

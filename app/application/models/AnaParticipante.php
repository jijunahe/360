 ...
 * @property string $jsonrespuestastemporales
 ...
 * @property string $nivelacademico
...
class AnaParticipante extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('keyid, apellido, nombre, email, usuario, keyproyecto, genero', 'length', 'max'=>100),
			array('clave, ciudad, pais', 'length', 'max'=>200),
			array('retroalimentacion, edad, antiguedad, nivelacademico, estadocivil', 'length', 'max'=>1),
			array('fecharegistro, jsonrespuestastemporales, fechaactualizacion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('keyid, apellido, nombre, email, usuario, clave, idUsuario, keyproyecto, fecharegistro, retroalimentacion, jsoncompetencias, jsonrespuestastemporales, fechaactualizacion, edad, genero, antiguedad, ciudad, pais, nivelacademico, estadocivil', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'jsonrespuestastemporales' => 'Jsonrespuestastemporales',
	...
	public function search()
	{
		...
		$criteria->compare('jsonrespuestastemporales',$this->jsonrespuestastemporales,true);
		...
		$criteria->compare('nivelacademico',$this->nivelacademico,true);

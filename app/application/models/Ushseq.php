...
class Ushseq extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('simplificado', 'length', 'max'=>1),
			array('fechainicio, fechafin, fecharegistro', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, estado, nombre, idorg, token, fechainicio, fechafin, fecharegistro, simplificado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('simplificado',$this->simplificado,true);
